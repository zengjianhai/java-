...
public class BIDR implements Serializable {
	...
	private Date logout_data;
	private int time_duretion;

	public BIDR() {
	}

	public BIDR(String login_ip, String NAS_ip, String login_name, Date login_data, Date logout_data,
			int time_duretion) {
	...
	public Date getLogout_data() {
		return logout_data;
	}

	public void setLogout_data(Date logout_data) {
		this.logout_data = logout_data;
	}
